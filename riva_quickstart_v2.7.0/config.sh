...
service_enabled_nlp=false #zem
service_enabled_tts=false #zem
...
MODEL_DEPLOY_KEY="" #"riva-trt-asr_offline_conformer_ctc_pipeline-am-streaming-offline" #"tlt_encode"
...
for lang_code in ${language_code[@]}; do
    ...
    if [[ $riva_target_gpu_family  == "tegra" ]]; then
      ...
      #     "${riva_ngc_org}/${riva_ngc_team}/rmir_asr_${asr_acoustic_model}_${modified_lang_code}_str${decoder}:${riva_ngc_model_version}"  #zem
    ...
    #   else
    #      models_asr+=(
    #         "${riva_ngc_org}/${riva_ngc_team}/rmir_nlp_punctuation_bert_base_${modified_lang_code}:${riva_ngc_model_version}" #zem
    #      )
    #   fi
    # fi
